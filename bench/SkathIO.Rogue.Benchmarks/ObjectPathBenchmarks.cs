...
/// against the equivalent object-dispatch path on MediatR (scenario 3), and against itself at 1 vs
/// 25 registered handler types (scenario 3b) to gather PD-3a evidence on whether the generated
/// <c>switch</c> dispatch scales sub-linearly — the question that gates the FrozenDictionary
/// deferral (NFR-PERF-5).
/// </summary>
/// <remarks>
...
/// <c>RogueDispatcher.SendObject</c> switch (boxes the response by design). So both libraries
...
public class ObjectPathBenchmarks
{
    ...
    public void Setup()
    {
        ...
        scalingServices.AddTransient<ICommandHandler<PingRequest, string>, PingHandler>();
        scalingServices.AddTransient<ICommandHandler<Scale01Request, int>, Scale01Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale02Request, int>, Scale02Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale03Request, int>, Scale03Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale04Request, int>, Scale04Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale05Request, int>, Scale05Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale06Request, int>, Scale06Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale07Request, int>, Scale07Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale08Request, int>, Scale08Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale09Request, int>, Scale09Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale10Request, int>, Scale10Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale11Request, int>, Scale11Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale12Request, int>, Scale12Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale13Request, int>, Scale13Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale14Request, int>, Scale14Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale15Request, int>, Scale15Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale16Request, int>, Scale16Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale17Request, int>, Scale17Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale18Request, int>, Scale18Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale19Request, int>, Scale19Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale20Request, int>, Scale20Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale21Request, int>, Scale21Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale22Request, int>, Scale22Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale23Request, int>, Scale23Handler>();
        scalingServices.AddTransient<ICommandHandler<Scale24Request, int>, Scale24Handler>();
...
public sealed record Scale01Request(int P) : ICommand<int>;
/// <summary>Scaling handler #2.</summary>
public sealed class Scale01Handler : ICommandHandler<Scale01Request, int>
...
public sealed record Scale02Request(int P) : ICommand<int>;
/// <summary>Scaling handler #3.</summary>
public sealed class Scale02Handler : ICommandHandler<Scale02Request, int>
...
public sealed record Scale03Request(int P) : ICommand<int>;
/// <summary>Scaling handler #4.</summary>
public sealed class Scale03Handler : ICommandHandler<Scale03Request, int>
...
public sealed record Scale04Request(int P) : ICommand<int>;
/// <summary>Scaling handler #5.</summary>
public sealed class Scale04Handler : ICommandHandler<Scale04Request, int>
...
public sealed record Scale05Request(int P) : ICommand<int>;
/// <summary>Scaling handler #6.</summary>
public sealed class Scale05Handler : ICommandHandler<Scale05Request, int>
...
public sealed record Scale06Request(int P) : ICommand<int>;
/// <summary>Scaling handler #7.</summary>
public sealed class Scale06Handler : ICommandHandler<Scale06Request, int>
...
public sealed record Scale07Request(int P) : ICommand<int>;
/// <summary>Scaling handler #8.</summary>
public sealed class Scale07Handler : ICommandHandler<Scale07Request, int>
...
public sealed record Scale08Request(int P) : ICommand<int>;
/// <summary>Scaling handler #9.</summary>
public sealed class Scale08Handler : ICommandHandler<Scale08Request, int>
...
public sealed record Scale09Request(int P) : ICommand<int>;
/// <summary>Scaling handler #10.</summary>
public sealed class Scale09Handler : ICommandHandler<Scale09Request, int>
...
public sealed record Scale10Request(int P) : ICommand<int>;
/// <summary>Scaling handler #11.</summary>
public sealed class Scale10Handler : ICommandHandler<Scale10Request, int>
...
public sealed record Scale11Request(int P) : ICommand<int>;
/// <summary>Scaling handler #12.</summary>
public sealed class Scale11Handler : ICommandHandler<Scale11Request, int>
...
public sealed record Scale12Request(int P) : ICommand<int>;
/// <summary>Scaling handler #13.</summary>
public sealed class Scale12Handler : ICommandHandler<Scale12Request, int>
...
public sealed record Scale13Request(int P) : ICommand<int>;
/// <summary>Scaling handler #14.</summary>
public sealed class Scale13Handler : ICommandHandler<Scale13Request, int>
...
public sealed record Scale14Request(int P) : ICommand<int>;
/// <summary>Scaling handler #15.</summary>
public sealed class Scale14Handler : ICommandHandler<Scale14Request, int>
...
public sealed record Scale15Request(int P) : ICommand<int>;
/// <summary>Scaling handler #16.</summary>
public sealed class Scale15Handler : ICommandHandler<Scale15Request, int>
...
public sealed record Scale16Request(int P) : ICommand<int>;
/// <summary>Scaling handler #17.</summary>
public sealed class Scale16Handler : ICommandHandler<Scale16Request, int>
...
public sealed record Scale17Request(int P) : ICommand<int>;
/// <summary>Scaling handler #18.</summary>
public sealed class Scale17Handler : ICommandHandler<Scale17Request, int>
...
public sealed record Scale18Request(int P) : ICommand<int>;
/// <summary>Scaling handler #19.</summary>
public sealed class Scale18Handler : ICommandHandler<Scale18Request, int>
...
public sealed record Scale19Request(int P) : ICommand<int>;
/// <summary>Scaling handler #20.</summary>
public sealed class Scale19Handler : ICommandHandler<Scale19Request, int>
...
public sealed record Scale20Request(int P) : ICommand<int>;
/// <summary>Scaling handler #21.</summary>
public sealed class Scale20Handler : ICommandHandler<Scale20Request, int>
...
public sealed record Scale21Request(int P) : ICommand<int>;
/// <summary>Scaling handler #22.</summary>
public sealed class Scale21Handler : ICommandHandler<Scale21Request, int>
...
public sealed record Scale22Request(int P) : ICommand<int>;
/// <summary>Scaling handler #23.</summary>
public sealed class Scale22Handler : ICommandHandler<Scale22Request, int>
...
public sealed record Scale23Request(int P) : ICommand<int>;
/// <summary>Scaling handler #24.</summary>
public sealed class Scale23Handler : ICommandHandler<Scale23Request, int>
...
public sealed record Scale24Request(int P) : ICommand<int>;
/// <summary>Scaling handler #25.</summary>
public sealed class Scale24Handler : ICommandHandler<Scale24Request, int>
